...
import com.notallyz.note.room.dao.BaseNoteDao
import com.notallyz.note.room.dao.CommonDao
import com.notallyz.note.room.dao.LabelDao
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * allowMainThreadQueries() is only used in [com.notallyz.note.ReminderReceiver.onReceive]
