...
import com.notallyz.note.databinding.ActivityMainBinding
import com.notallyz.note.databinding.DialogColorBinding
...
import com.notallyz.note.recyclerview.adapter.ColorAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleDestinationChange(destination: NavDestination) {
        ...
        if (destination.id == R.id.Search) {
            ...
            binding.EnterSearchKeyword.postDelayed({
